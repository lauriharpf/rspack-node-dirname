...
__webpack_require__.f.css = function (chunkId, promises, fetchPriority) {
	...
	if (installedChunkData !== 0) {
		...
		if (installedChunkData) {
			...
			if ("src_foo_bar_baz_render_js" == chunkId) {
...
__webpack_require__.e(/*! import() */ "src_foo_bar_baz_render_js").then(__webpack_require__.bind(__webpack_require__, /*! ./foo/bar/baz/render */ "./src/foo/bar/baz/render.js")).then(exports => {
    exports.render()
})
